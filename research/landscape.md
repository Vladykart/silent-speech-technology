...
- **Silent facial EMG:** Gaddy & Klein’s peer-reviewed EMNLP 2020 and ACL 2021 work [R03, R04] reports open-vocabulary synthesis/recognition research in a single-speaker line. The official MIT-licensed code at commit `a89357c2086609b432919b9d14ffc0be5d8983d5` points to separate CC BY 4.0 Zenodo data/model records [R05, R16, R34]. Updated 2026-07-31: official assets were fetched outside git and the released preprocessing/model mel+phoneme forward path was exercised on selected real records; the legacy vocoder/DeepSpeech evaluation was not reproduced.
...
- Zenodo record 6747411 labels pretrained model artifacts CC BY 4.0 [R16]; dependencies and training-data-subject/intended-use rights remain separate. Updated 2026-07-31: the 253,447,725-byte archive/checkpoint was fetched to ignored local storage, checksum verified and used for non-commercial local replay; it is not committed or project-owned.
