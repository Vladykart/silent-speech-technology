...
**Research freeze for this release:** 2026-07-28. All links were last assessed on that date unless a row says otherwise.
...
5. No paper, model, dataset, third-party slide, font, image, or codebase was downloaded into this repository. GitHub evidence was inspected through `gh-axi`; exact commits are recorded.
