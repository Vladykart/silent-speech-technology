...
4. **Gaddy artifacts have separable terms.** Zenodo record `10.5281/zenodo.4064409` reports “Silent Speech EMG” v1.0, CC BY 4.0, one 3,919,507,637-byte archive (MD5 `7f97d2182b896652999b1b2d0c69fd7b`). It was not downloaded. The code repository is MIT; code/data/model/dependencies still require separate reviews.
