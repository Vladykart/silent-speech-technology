...
REQUIRED = (
    ...
    "assets-manifest.json", "sample-manifest.json", "model-registry.json", "release-manifest.json",
    "generate_release_manifest.py", "fetch_assets.py", "requirements.txt", "run-local.sh",
    "app/config.py", "app/asset_registry.py", "app/signal_source.py", "app/preprocessing.py",
    ...
    "tests/test_api.py", "tests/client_contract.test.js", "tests/responsive_contract.test.py", "tests/rendered_browser_qa.mjs",
...
def main() -> int:
    ...
    assets, samples, models = load("assets-manifest.json"), load("sample-manifest.json"), load("model-registry.json")
