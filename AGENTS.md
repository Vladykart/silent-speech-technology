...
- Software expansion authority: [`research/software-expansion-review.md`](research/software-expansion-review.md), `realtime/model-registry.json`, and `realtime/evaluation-protocol.json`. More component names or replay cards do not widen claims; new assets, models, samples, training, metrics, or execution require a separate reviewed cycle.
