...
- Quick validation: `python3 tools/validate_project.py && python3 demo/generate_manifest.py && python3 demo/validate.py && node demo/tests/core.test.js && python3 lab/validate.py && python3 -m unittest lab/tests/test_lab.py && python3 pitch/validate.py && python3 pitch/validate_pptx.py && python3 pitch/validate_4_slide_pptx.py && python3 realtime/validate.py`; after local dependencies exist, add `realtime/.venv/bin/python -m unittest discover -s realtime/tests -v`.
