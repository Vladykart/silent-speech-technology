...
REQUIRED=[
 ...
 "research/references.md","research/presentation-review.md","research/scout-review.md","research/software-expansion-review.md",
 ...
 "realtime/assets-manifest.json","realtime/sample-manifest.json","realtime/model-registry.json","realtime/evaluation-protocol.json","realtime/release-manifest.json","realtime/generate_release_manifest.py",
 "realtime/app/asset_registry.py","realtime/app/display_payload.py","realtime/app/evaluation_protocol.py","realtime/app/service.py","realtime/client/index.html",
